...
class SimGrav extends Frame implements ActionListener{
	...
	public static void main (String[]args) throws IOException{
		new SimGrav().setVisible(true);
	}
	
	public SimGrav(){
		setSize(W,H);
		setLocation(150,50);
		setTitle("(Nueva) Simulación de interacción gravitatoria");
	...
	public void actionPerformed(ActionEvent x){
		...
		if(x.getSource()==b[0]){M.graficarG(N,n,v,cv);}
